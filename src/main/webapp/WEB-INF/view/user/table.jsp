                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <h4 class="m-b-30 m-t-0">Bordered Table</h4>
                                ...
                                <div class="col-md-6">
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <h4 class="m-b-30 m-t-0">Hover Table</h4>
                                            <div class="row">
                                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <h4 class="m-b-30 m-t-0">Responsive Table</h4>
                                            <div class="row">
                                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <h4 class="m-b-30 m-t-0">Contextual Table</h4>
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <table class="table">
                                                        <thead>
